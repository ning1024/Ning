...
public class BaseDict {
	...
	private String dict_id;	//字典序号
	private String dict_type_code;//字典类别代码
	private String dict_type_name;//字典类别名称
	private String dict_item_name;//某个字典项名称
	private String dict_item_code;//某个数据字典项目代码
